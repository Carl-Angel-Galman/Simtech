...
\begin{align}
\frac{1}{\cos(\beta)} &\approx 1,\\
\frac{\cos(\delta)}{\cos(\beta)} &\approx 1.
\end{align}

Damit folgt die linearisiert dargestellte Struktur (ohne Einsetzen von $\alpha_v^{\mathrm{lin}},\alpha_h^{\mathrm{lin}}$):
\begin{equation}
\boxed{
\dot{\beta}^{\mathrm{lin}}
\;=\;
