...
\begin{figure}[h]
    ...
    \caption{Bodediagramm des Schwimmwinkel $\beta$ bei Verwendung des nichtlinearen Einspurmodells bei einem Lenkwinkelsprung auf $1^\circ$:
    Amplitudengang (oben) und Phasengang (unten).}
    \label{fig:aufgabe4bode}
\end{figure}

\subsection{Interpretation}
Abbildung~\ref{fig:aufgabe4bode} zeigt den Amplituden- und Phasengang der \"Ubertragungsfunktion von $\delta$ nach $\beta$.
